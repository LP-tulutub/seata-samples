...
public class GeneratorCodeConfig {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/nacos-table1-service/src/main/java");
        // TODO 设置用户名
        gc.setAuthor("root");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/seata?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2b8");
...
//        tableFillList.add(updateField);
        ...
        strategy.setInclude("table1"); // 多个表 , 号分割
